module github.com/arnabghose997/somechain
...
require (
	...
	github.com/ignite-hq/cli v0.0.0-00010101000000-000000000000
...
replace (
	...
	github.com/ignite-hq/cli => github.com/ignite/cli v0.23.0
